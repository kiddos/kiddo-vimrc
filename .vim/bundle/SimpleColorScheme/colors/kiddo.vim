...
hi	Pmenu		cterm=bold		ctermbg=28		ctermfg=255		gui=bold	guibg=#339900	guifg=#FFFFFF
hi	PmenuSel	cterm=bold		ctermbg=34		ctermfg=255		gui=bold	guibg=#33CC00	guifg=#FFFFFF
...
hi	Function	cterm=NONE		ctermfg=42		gui=NONE	guifg=#FF9900
...
"" statusline style
source ~/.vim/bundle/SimpleColorScheme/colors/statusline.vim
